...
const ApiKeyErrorResponseSchema = registry.register(
    'ApiKeyErrorResponse',
    z.object({
...
const ApiKeyPublicRecordSchema = registry.register(
    'ApiKeyPublicRecord',
    z.object({
...
const ApiKeyCreateResponseSchema = registry.register(
...
const ApiKeySuccessEnvelopeSchema = registry.register(
    'ApiKeySuccessEnvelope',
    z.object({
