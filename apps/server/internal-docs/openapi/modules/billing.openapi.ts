...
const BillingErrorResponseSchema = registry.register(
...
const BillingSubscriptionIntentSchema = registry.register(
    'BillingSubscriptionIntent',
    z.object({
...
const BillingSubscriptionRecordSchema = registry.register(
...
const BillingSuccessEnvelopeSchema = registry.register(
...
registry.registerPath({
    ...
    description:
        'Creates a subscription intent/order. Requires tenant context and owner/admin membership role.',
    tags: ['Billing'],
...
registry.registerPath({
    ...
    description:
        'Public endpoint for payment events. Signature validation is mandatory via x-razorpay-signature header.',
    tags: ['Billing'],
    request: {
        headers: z.object({
