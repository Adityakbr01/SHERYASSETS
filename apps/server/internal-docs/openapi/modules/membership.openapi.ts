...
const MembershipErrorResponseSchema = registry.register(
...
const MembershipRecordSchema = registry.register(
    'MembershipRecord',
    z.object({
...
const MembershipWithTenantSchema = registry.register(
...
const MembershipSuccessEnvelopeSchema = registry.register(
    'MembershipSuccessEnvelope',
    z.object({
...
registry.registerPath({
    ...
    description:
        'Owner/admin can invite admin/member users. Includes anti-spam cooldown and duplicate-invite safeguards.',
    tags: ['Membership'],
    security: [{ bearerAuth: [] }, { cookieAuth: [] }],
    request: {
        headers: z.object({
                    ...
                    examples: {
                        wrongEmail: {
                            value: {
                                success: false,
                                message:
                                    'This invitation was sent to a different email address. Please create an account with the invited email or login with the correct account first, then try again.',
                            },
                        },
                    },
                },
