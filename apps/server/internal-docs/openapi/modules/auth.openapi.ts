...
const AuthErrorItemSchema = registry.register(
    'AuthErrorItem',
    z.object({
...
const AuthTenantSchema = registry.register(
    'AuthTenant',
    z.object({
...
const AuthSuccessEnvelopeSchema = registry.register(
    'AuthSuccessEnvelope',
    z.object({
...
const LoginRegisterResponseSchema = registry.register(
...
const SwitchTenantResponseSchema = registry.register(
    'AuthSwitchTenantResponse',
    z.object({
        success: z.literal(true),
...
registry.registerPath({
    ...
    description:
        'Sends a one-time password to the provided email if the account is not already registered. Cooldown is enforced to prevent abuse.',
    tags: ['Auth'],
    request: {
        body: {
            required: true,
...
registry.registerPath({
    ...
    description:
        'Creates a user and default tenant using email OTP verification. Returns access and refresh tokens in both body and cookies.',
    tags: ['Auth'],
    request: {
        body: {
            required: true,
...
registry.registerPath({
    ...
    description:
        'Generates a fresh access token bound to a selected tenant. Required before tenant-scoped endpoints unless activeTenantId is already present in JWT.',
    security: [{ bearerAuth: [] }, { cookieAuth: [] }],
    tags: ['Auth'],
    request: {
        body: {
...
registry.registerPath({
    ...
    description:
        'Logs out current user session and clears auth cookies. Accepts optional refresh token in body.',
    security: [{ bearerAuth: [] }, { cookieAuth: [] }],
    tags: ['Auth'],
    request: {
        body: {
